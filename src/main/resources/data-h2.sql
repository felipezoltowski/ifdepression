...
insert into deck(ID, NICKNAME, CLANNAME, KINGTOWERLEVEL, ARENA, EMAIL, DECKNAME, GUIDE, STATUS, DELETION) values (4, 'Littlejoker', 'Cerveja Furacão', 9, 8, 'littlejoker@hotmail.com', 'Hog Prince', 'This deck blá blá blá...', true, null);
